...
% define footer text
\newcommand{\footlinetext}{CSCS-USI Summer University 2022}
...
\subtitle{CSCS-USI Summer University 2022}
\date{July 11--25, 2022}
...
\begin{frame}{What is OpenACC?}
  ...
  \item Current specification version: 3.2
...
\begin{frame}[fragile]{Leverage the unified memory}
  ...
  \item Supported by the NVIDIA compiler using the \shinline{-ta=tesla:managed} option
  \end{itemize}
\end{frame}
...
\begin{frame}[fragile]{Hands-on exercises}{General information}
  ...
  \item NVIDIA compiler is recommended, GNU and Cray compiler are present in \shinline{make} files
...
\begin{frame}{Hands-on}{Exercise 1 -- AXPY}
  ...
  \item Run as: \shinline{srun --reserv=summer_uni1 -Cgpu ./axpy.openacc [ARRAY\_SIZE]}
    \begin{itemize}
...
\begin{frame}{Hands-on}{Exercise 2 -- Dot product}
  ...
  \item Run as: \shinline{srun --reserv=summer_uni1 -Cgpu ./dot.openacc [ARRAY\_SIZE]}
    \begin{itemize}
...
\begin{frame}{Hands-on}{Exercise 3 -- 1D blur kernel}
  ...
  \item Run as: \shinline{srun --reserv=summer_uni1 -Cgpu ./blur.openacc [ARRAY\_SIZE]}
    \begin{itemize}
...
\begin{frame}[fragile]{Hands-on}{Exercise 5 -- Calling cuBLAS methods}
  ...
  \item Run as: \shinline{srun --reserv=summer_uni1 -Cgpu ./gemm.openacc [ARRAY\_SIZE]}
    \begin{itemize}
...
\begin{frame}[fragile]{Hands-on}{Exercise 6.1 -- 2D diffusion example}
  ...
  \item \shinline{diffusion2d\_openacc.\{cpp,f90\}}
    ...
    \item Single node OpenACC version
      \item Run as: \shinline{srun --reserv=summer_uni1 -Cgpu ./diffusion2d.openacc [ARRAY\_SIZE]}
        \begin{itemize}
        \item \shinline{ARRAY\_SIZE} is power of 2, default is 16
        \end{itemize}
...
\begin{frame}[fragile]{Hands-on}{Exercise 6.2 -- 2D diffusion example using CUDA data management}
  ...
  \item \shinline{diffusion2d\_openacc.\{cpp,f90\}}
    \begin{itemize}
    \item Single node OpenACC version
      \item Run as: \shinline{srun --reserv=summer_uni1 -Cgpu ./diffusion2d.openacc.cuda [ARRAY\_SIZE]}
        \begin{itemize}
        \item \shinline{ARRAY\_SIZE} is power of 2, default is 16
        \end{itemize}
...
\begin{frame}{OpenACC and compiler support}
  ...
  \item Cray
    ...
    \item From CCE 9.0 onward support was dropped but is resumed now
    \end{itemize}
  \item GCC
    \begin{itemize}
...
\begin{frame}{More information and events}
  ...
  \item GPU Hackathons
    ...
    \item Several in person / virtual events scheduled for 2022
